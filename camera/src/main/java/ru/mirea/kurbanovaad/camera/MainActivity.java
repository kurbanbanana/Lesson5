package ru.mirea.kurbanovaad.camera;
...
import ru.mirea.kurbanovaad.camera.databinding.ActivityMainBinding;
...
public	class	MainActivity	extends	AppCompatActivity implements ActivityResultCallback<ActivityResult>{
    ...
    public void OnUpdatePhoto(View v) {
        ...
        try {
            ...
            String authorities = "ru.mirea.kurbanovaad.camera.fileprovider";
